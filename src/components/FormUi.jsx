  ...
  return (
    <>
      <div className="  rounded p-5 bg-white">
        ...
        <div className="h-32 m-5 ml-0 mr-0 bg-indigo-400 text-white flex flex-col justify-center items-center">
          <i className="fa-solid fa-indian-rupee-sign text-5xl"></i>
          <p className="capitalize">total simple interest</p>
        </div>
        <form>
          ...
          <div className="flex m-4 ml-0 mr-0 gap-2">
            <button className="bg-black text-white p-2 w-full border-2 border-black hover:bg-gray-800 transition-all duration-300 ease-in-out rounded-md font-bold tracking-widest">
              calculate
            </button>
            <button
              type="reset"
